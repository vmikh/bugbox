(function (factory) {
    ...
    class Widget {
        constructor(googleSheetLink, isHidden, platformName, deviceType) {
            ...
            this.stylesLink = (window.location.host === 'localhost:1001') ? 'app.css' : (window.location.hostname === 'bugboxio.netlify.app') ? 'https://vmikh.github.io/bugbox/dist/test/app-min.css' : 'https://vmikh.github.io/bugbox/dist/prod/app-min.css';
